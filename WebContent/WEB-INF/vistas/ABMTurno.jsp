			...
			<%@ page import="entidad.PerfilUsuario" %>
				...
				<body>
					<% Usuario usuario=(Usuario) session.getAttribute("user");
						if(request.getSession().getAttribute("user")!=null && usuario.getPerfil()
						!=PerfilUsuario.MEDICO.getPerfilUsuario()){ %>
						<%@include file="Menu.jsp" %>
								...
								<div class="formulario">
									...
									<table>
										...
										<tr>
											...
											<td><input type="text" name="txtNombrePaciente" id="nombrePaciente"
													value="${paciente.nombre}" readonly style="background-color: #eee;">
											</td>
										</tr>
										<tr>
											<td><label>Apellido</label></td>
											<td><input type="text" name="txtApellidoPaciente" id="apellidoPaciente"
							...
							<%}else{ response.sendRedirect("Access.do"); } %>
				</body>
