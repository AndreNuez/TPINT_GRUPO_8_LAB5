...
public class ControladorABMLPacientes {
	...
	public ModelAndView eventoAMBPaciente(@ModelAttribute("paciente") Paciente paciente, Integer selProvincia,
			Integer selLocalidad, HttpSession session, String btnGrabar, String btnActualizar) {
